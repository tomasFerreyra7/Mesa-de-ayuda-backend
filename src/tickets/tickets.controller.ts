...
export class TicketsController {
  ...
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateTicketDto, @CurrentUser() user: Usuario) {
    return this.service.update(id, dto, user);
  }

  @Patch(':id/estado')
  @ApiOperation({ summary: 'Cambiar estado del ticket' })
  cambiarEstado(@Param('id', ParseIntPipe) id: number, @Body() dto: CambiarEstadoDto, @CurrentUser() user: Usuario) {
  ...
  asignar(@Param('id', ParseIntPipe) id: number, @Body() dto: AsignarTicketDto, @CurrentUser() user: Usuario) {
  ...
  @ApiOperation({ summary: 'Eliminar ticket de la DB (hard delete, solo admin)' })
  ...
  addComentario(@Param('id', ParseIntPipe) id: number, @Body() dto: CreateComentarioDto, @CurrentUser() user: Usuario) {
